...
namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        public Adventurer(string name, string robe)
        {
            Name = name;
            Awesomeness = 50;
        ...
        {
            string robeColors = String.Join("and", ColorfulRobe.Color);
            string details = $"Adventurer, {Name}, is wearing a {robeColors} robe that is {ColorfulRobe.Length} inches long! :)";
            return details;
        }
